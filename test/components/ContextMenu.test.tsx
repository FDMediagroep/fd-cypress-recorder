...
describe('Context Menu', () => {
    ...
    beforeEach(() => {
        ...
        act(() => {
            ReactDOM.render(
                <ContextMenu target={target} selector={'.context-menu-test'} />,
                target
            );
        });
    });
    ...
    it('should handle manual Click event correctly', () => {
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'click'
                ) {
    ...
    it('should handle manual Text entering event correctly', () => {
        ...
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'enter text...'
                ) {
                    li.dispatchEvent(mouseDownEvt);
                }
            });
    ...
    it('should handle manual Contains text event correctly', () => {
        ...
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'contains text...'
                ) {
                    li.dispatchEvent(mouseDownEvt);
                }
            });
    ...
    it('should handle Hover event correctly', () => {
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'hover'
                ) {
                    li.dispatchEvent(mouseDownEvt);
                }
            });
    ...
    it('should handle manual Go to URL event correctly', () => {
        ...
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'go to url...'
                ) {
                    li.dispatchEvent(mouseDownEvt);
                }
            });
    ...
    it('should handle Visit event correctly', () => {
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'visit current url'
                ) {
                    li.dispatchEvent(mouseDownEvt);
                }
            });
    ...
    it('should handle Match Current URL event correctly', () => {
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'match current url'
                ) {
                    li.dispatchEvent(mouseDownEvt);
                }
            });
    ...
    it('should handle manual URL contains event correctly', () => {
        ...
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'url contains...'
                ) {
                    li.dispatchEvent(mouseDownEvt);
                }
            });
    ...
    it('should handle Attributes... event correctly', () => {
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'attributes...'
                ) {
                    li.dispatchEvent(mouseDownEvt);
                }
            });
    ...
    it('should handle Count... event correctly', () => {
        [].slice
            ...
            .forEach((li: HTMLLIElement) => {
                if (
                    li.textContent &&
                    li.textContent.toLowerCase() === 'count...'
                ) {
                    li.dispatchEvent(mouseDownEvt);
                }
            });
